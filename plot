...
# Example usage: 
#     ./parse_log.sh log
# Now you have log.train and log.test.
...
# plot "log.train" using 2:3 title "mnist"

# Learning rate vs. training iterations;
# plot "log.train" using 1:4 title "mnist"

# Learning rate vs. training time;
# plot "log.train" using 2:4 title "mnist"
...
# plot "log.test" using 1:4 title "mnist"

# Test accuracy vs. training iterations
# plot "log.test" using 1:3 title "mnist"

# Test loss vs. training time
# plot "log.test" using 2:4 title "mnist"

# Test accuracy vs. training time
# plot "log.test" using 2:3 title "mnist"
